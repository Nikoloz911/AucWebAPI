    ...
    <table style='width: 100%; max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);'>
        <tr>
            <td style='background-color: #7B2CBF; color: #ffffff; text-align: center; padding: 20px;'>
                <h1 style='font-size: 26px; margin: 0;'>AuctionMaster Verification</h1>
        ...
        <tr>
            <td style='padding: 20px 40px; text-align: left;'>
                ...
                <p style='font-size: 18px; line-height: 1.6; margin: 0 0 25px;'>Welcome to AuctionMaster! Please use the following one-time verification code to complete your registration:</p>
                
                <div style='background-color: #121212; border-radius: 8px; padding: 25px; margin: 30px 0; text-align: center; border: 1px solid #333;'>
                    <div style='font-size: 42px; font-weight: 700; letter-spacing: 3px; color: #9D4EDD;'>{verificationCode}</div>
                    <div style='font-size: 14px; color: #aaa; margin-top: 10px;'>Expires in 5 minutes</div>
                </div>
                
                <p style='font-size: 16px; line-height: 1.6; margin: 0 0 15px; color: #666;'>Simply enter this code where prompted to complete your registration and start bidding on exciting items!</p>
            </td>
        </tr>
...
";
        ...
        mail.Subject = "AuctionMaster - Your Verification Code";
